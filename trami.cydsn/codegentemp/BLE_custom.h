...
#define CYBLE_CAPSENSE_CAPSENSE_SLIDER_CHAR_INDEX   (0x00u) /* Index of CapSense Slider characteristic */
#define CYBLE_CAPSENSE_CAPSENSE_SLIDER_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENSE_CAPSENSE_SLIDER_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */

#define CYBLE_RGB_LED_SERVICE_INDEX   (0x01u) /* Index of RGB LED service in the cyBle_customs array */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHAR_INDEX   (0x00u) /* Index of RGB LED Control characteristic */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CYBLE_CAPSENSE_SERVICE_HANDLE   (0x000Cu) /* Handle of CapSense service */
#define CYBLE_CAPSENSE_CAPSENSE_SLIDER_DECL_HANDLE   (0x000Du) /* Handle of CapSense Slider characteristic declaration */
#define CYBLE_CAPSENSE_CAPSENSE_SLIDER_CHAR_HANDLE   (0x000Eu) /* Handle of CapSense Slider characteristic */
#define CYBLE_CAPSENSE_CAPSENSE_SLIDER_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENSE_CAPSENSE_SLIDER_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */

#define CYBLE_RGB_LED_SERVICE_HANDLE   (0x0011u) /* Handle of RGB LED service */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_DECL_HANDLE   (0x0012u) /* Handle of RGB LED Control characteristic declaration */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHAR_HANDLE   (0x0013u) /* Handle of RGB LED Control characteristic */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0015u) /* Handle of Characteristic User Description descriptor */
